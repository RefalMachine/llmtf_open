...
if __name__ == '__main__':
    ...
    model = MODEL_CLASS(
        ...
        alpha_scale=args.alpha_scale, not_scale_lm_head=args.not_scale_lm_head, max_seq_len_to_capture=args.max_prompt_len)
    ...
    if args.ppl_scoring:
        evaluator.evaluate_ppl(model, args.output_dir, args.dataset_names, args.max_prompt_len, args.few_shot_count, batch_size=args.batch_size, max_sample_per_dataset=args.max_sample_per_dataset, force_recalc=args.force_recalc, name_suffix=args.name_suffix)
    else:

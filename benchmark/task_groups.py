...
task_groups_skills = [
    ...
    {'name': 'sentiment', 'params': {'dataset_names': 'sentiment_kinopoisk ruopinionne ruopinionne_simple'}},
...
task_groups =  task_groups_rag + task_groups_skills + task_groups_knowledge + task_groups_ifeval + task_groups_knowledge_few_shot + task_groups_long
